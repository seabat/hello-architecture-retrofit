...
sealed class HelloException(val errType: ErrorType, errMessage: String? = null) : Exception(errMessage) {
    class HttpException(errType: ErrorType, errMessage: String? = null, val responseStatus: Int) : HelloException(errType, errMessage)
    class NetworkTimeoutException(errType: ErrorType, errMessage: String? = null) : HelloException(errType, errMessage)
    class StorageIOException(errType: ErrorType, errMessage: String? = null) : HelloException(errType, errMessage)
